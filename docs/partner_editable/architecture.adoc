...
//TODO Andrew, Does the Application Load Balancer belong inside the subnet? If not, please move the icon and this subbullet. (I've updated the .pptx file; work from the latest version in GitHub.)
...
//TODO Andrew, In various places we talk about AIT Server, AIT Editor, and Open MCT as a triad. How might we show all three components in the diagram?
...
//TODO Andrew, Is it accurate for Amazon ES to be the only service icon inside the VPC?
...
//TODO Andrew, how could the diagram show the flow between some of these free-floating components?
//TODO Andrew, How would we show the Docker container come into play in the diagram?
//TODO Andrew, How would we describe the Docker container's function in the bulleted list?