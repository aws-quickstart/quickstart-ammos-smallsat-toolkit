...
** An EC2 instance that serves the AIT Sequence Editor application. This application runs in a Docker container on the instance to mitigate the impact of system commands that are executed from the VS Code–integrated terminal that's exposed in the browser.
