...
//TODO Andrew, I added the above reference to GovCloud based on this line (in regions.adoc, which we don't use in building docs any more): "The deployment is compatible with the aws-us-gov partition." Did I interpret correctly?
//TODO Andrew, If correct, is GovCloud important enough to mention on the landing page too? I think there's even a GovCloud logo that goes on certain landing pages. 
