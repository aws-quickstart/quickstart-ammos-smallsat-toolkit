...
. Sign in to your AWS account, and https://fwd.aws/p5Pxb?[deploy {partner-product-short-name} into a new VPC^]. For details, see link:#_deployment_options[Deployment options] earlier in this guide. (https://fwd.aws/KbM3z?[View template^].)
