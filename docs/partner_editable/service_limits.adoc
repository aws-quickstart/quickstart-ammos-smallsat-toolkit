...
//TODO Andrew, In the description for the parameter AITInstanceType, we claim that the deployment guide recommends instance types to use for AIT. I don't that info in the guide, though. Please supply recommendations.
