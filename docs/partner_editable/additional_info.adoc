...
The AIT Sequence Editor EC2 instance runs `cdr/code-server`. When you use Visual Studio Code's integrated terminal, you can run system-level commands from a browser.
