...
:quickstart-project-name: NASA Multi-Mission Ops System Starter 
:partner-product-name: NASA Multi-Mission Ops System Starter
// For the following attribute, if you have no short name, enter the same name as partner-product-name.
:partner-product-short-name: NASA Multi-Mission Ops System Starter
// If there's no partner, comment partner-company-name.
:partner-company-name: Jet Propulsion Laboratory
:doc-month: September
:doc-year: 2021
...
//:partner-contributors: Michaelle Fedell and Steven Liu {partner-company-name}
//:other-contributors: Akua Mansa, Trek10
//:aws-contributors: Janine Singh, AWS IoT Partner team
:quickstart-contributors: Andrew Glenn, AWS Quick Starter Team
